...
public:
    ...
    struct NodeMobility {
        ...
        void operator()(const int &i) const {
            ...
            // Sphere-surface constraint: remove radial velocity component
            // so the node can only slide tangentially along the sphere surface.
...
#include "mobility_bcc0b_orowan_geometry.h"
