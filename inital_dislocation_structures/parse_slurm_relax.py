...
# ========== 配置 ==========
SLURM_LOG  = "slurm-334120.out"                              # 作业日志(含每步 nodes/dt)
DAT_FILE   = "output_diag_relax_seed12345/stress_strain_dens.dat"  # 含 density
OUTPUT_PNG = "relax_convergence_from_slurm.png"
TAIL_FRAC  = 0.20
RHO_TOL    = 0.01
# =========================
